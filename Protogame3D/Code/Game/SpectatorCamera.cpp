...
constexpr float SPECTATOR_CAMERA_MOVE_SPEED = 2.f;
constexpr float SPECTATOR_CAMERA_YAW_TURN_RATE = 60.f;
constexpr float SPECTATOR_CAMERA_PITCH_TURN_RATE = 60.f;
constexpr float SPECTATOR_CAMERA_ROLL_TURN_RATE = 90.f;
constexpr float SPECTATOR_CAMERA_SPEED_FACTOR = 10.f;
